...
Size_of_Mega_PCM_guess = $840

MegaPCM:
	save
	include	"sound/SMPS M68K/MegaPCM - Z80.asm"
	restore
	padding off
...
Name:		label *
    if ("Path"<>"")
	if ("Extension"="WAV")
		BINCLUDE	"sound/SMPS M68K/DAC/Path/Name.Extension",$3A
	else
		BINCLUDE	"sound/SMPS M68K/DAC/Path/Name.Extension"
	endif
    else
	if ("Extension"="WAV")
		BINCLUDE	"sound/SMPS M68K/DAC/Name.Extension",$3A
	else
		BINCLUDE	"sound/SMPS M68K/DAC/Name.Extension"
	endif
    endif
Name_End:	label *
	endm
