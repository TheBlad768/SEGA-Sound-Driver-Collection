...
; =============================================================================================
; This modification adds a Driver Version '0': Clone Driver v2
SonicDriverVer = 0
...
; and ensure that the ending note is indeed the maximum PSG frequency.
	if SonicDriverVer>=3|SonicDriverVer==0
...
; PSG volume envelope equates
	if SonicDriverVer==0
		...
		; Sonic 3 & K & 3D
		enum sTone_01=fTone_0D+1,sTone_02,sTone_03,sTone_04,sTone_05,sTone_06
		enum sTone_07=sTone_06+1,sTone_08,sTone_09,sTone_0A,sTone_0B,sTone_0C
		enum sTone_0D=sTone_0C+1,sTone_10,sTone_11,sTone_14,sTone_18,sTone_1A
		enum sTone_1C=sTone_1A+1,sTone_1D,sTone_1E,sTone_1F,sTone_20,sTone_21
		enum sTone_22=sTone_21+1,sTone_23,sTone_24,sTone_25,sTone_26,sTone_27
...
convertMainTempoMod macro mod
	if ((SourceDriver>=3)&&(SonicDriverVer>=3))|((SourceDriver>=3)&&(SonicDriverVer==0))|(SonicDriverVer==SourceDriver)
		dc.b	mod
...
smpsNoteFill macro val
	if (SonicDriverVer>=5)&&(SourceDriver<3)
		...
		dc.b	$FF,$0A,val
	elseif (SonicDriverVer==0)&&(SourceDriver>=3)
		; Unique to the Clone Driver v2
		dc.b	$FF,$1D,val
	else
...
smpsContinuousLoop macro loc
	if (SonicDriverVer==0)&&(EnableContSFX==1)
		dc.b	$FF,$1E
	else
		dc.b	$FC
	endif
...
smpsFMICommand macro reg,val
	...
	if SonicDriverVer>=5|SonicDriverVer==0
