Snd_music_Header:
	...
	smpsHeaderFM        Snd_music_FM1,	$0C, $08
	smpsHeaderFM        Snd_music_FM2,	$00, $0D
	smpsHeaderFM        Snd_music_FM3,	$00, $12
	smpsHeaderFM        Snd_music_FM4,	$00, $12
	smpsHeaderFM        Snd_music_FM5,	$00, $12
	smpsHeaderPSG       Snd_music_PSG1,	$E8, $04, $00, fTone_0C
	smpsHeaderPSG       Snd_music_PSG2,	$E8, $06, $00, fTone_0C
	smpsHeaderPSG       Snd_music_PSG3,	$E8, $08, $00, fTone_0C
...
Snd_music_Loop06:
	...
	smpsLoop            $00, $04, Snd_music_Loop06
	smpsJump            Snd_music_FM1
...
Snd_music_Loop04:
	...
	smpsLoop            $00, $02, Snd_music_Loop04

Snd_music_Loop05:
	smpsCall            Snd_music_Call00
	smpsLoop            $00, $04, Snd_music_Loop05
	smpsJump            Snd_music_Loop04
...
Snd_music_Loop01:
	...
	smpsLoop            $00, $02, Snd_music_Loop01

Snd_music_Loop02:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $08, Snd_music_Loop02

Snd_music_Loop03:
	smpsAlterPitch      $0C
	smpsCall            Snd_music_Call00
	smpsAlterPitch      $F4
	smpsLoop            $00, $02, Snd_music_Loop03
	smpsJump            Snd_music_FM3
...
Snd_music_Loop07:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $04, Snd_music_Loop07
...
Snd_music_Loop00:
	...
	dc.b	dFloorTom, $04
	smpsLoop            $00, $08, Snd_music_Loop00
	smpsJump            Snd_music_DAC
