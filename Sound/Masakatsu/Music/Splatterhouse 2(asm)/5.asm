; Start
		dc.b 1
		dc.b $FF
		MasakatsuLoadChannel Channel_638A4	; 0
		MasakatsuLoadChannel Channel_63937	; 1
		MasakatsuLoadChannel Channel_639B2	; 2
		MasakatsuLoadChannel Channel_63A2A	; 3
		MasakatsuLoadChannel Channel_63AD1	; 4
		MasakatsuLoadChannel Channel_63AF0	; 5
		MasakatsuLoadChannel Channel_63B5C	; 6
		MasakatsuLoadChannel Channel_63B70	; 7
		MasakatsuLoadChannel Channel_63B88	; 8
; ---------------------------------------------------------------------------
