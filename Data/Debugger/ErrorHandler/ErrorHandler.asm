...
BusError:
	__ErrorMessage "%<.l Str_PtrContactInfo str>BUS ERROR", _eh_default|_eh_address_error

AddressError:
	__ErrorMessage "%<.l Str_PtrContactInfo str>ADDRESS ERROR", _eh_default|_eh_address_error

IllegalInstr:
	__ErrorMessage "%<.l Str_PtrContactInfo str>ILLEGAL INSTRUCTION", _eh_default

ZeroDivide:
	__ErrorMessage "%<.l Str_PtrContactInfo str>ZERO DIVIDE", _eh_default

ChkInstr:
	__ErrorMessage "%<.l Str_PtrContactInfo str>CHK INSTRUCTION", _eh_default

TrapvInstr:
	__ErrorMessage "%<.l Str_PtrContactInfo str>TRAPV INSTRUCTION", _eh_default

PrivilegeViol:
	__ErrorMessage "%<.l Str_PtrContactInfo str>PRIVILEGE VIOLATION", _eh_default

Trace:
	__ErrorMessage "%<.l Str_PtrContactInfo str>TRACE", _eh_default

Line1010Emu:
	__ErrorMessage "%<.l Str_PtrContactInfo str>LINE 1010 EMULATOR", _eh_default

Line1111Emu:
	__ErrorMessage "%<.l Str_PtrContactInfo str>LINE 1111 EMULATOR", _eh_default

ErrorExcept:
	__ErrorMessage "%<.l Str_PtrContactInfo str>ERROR EXCEPTION", _eh_default

Str_PtrContactInfo:	dc.l Str_ContactInfo
Str_ContactInfo: 		dc.b pal2, "Please report this data to ", pal3, "TheBlad768 ", pal1, endl, endl, 0
...
ErrorHandler:
	stopZ80
	binclude "Data/Debugger/ErrorHandler/ErrorHandler.bin"
